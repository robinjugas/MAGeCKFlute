...
#' @rdname EnrichSquare
#'
#' @param beta Data frame, with columns of "GeneID", "group", and "Diff".
...
EnrichSquare <- function(beta, id = "GeneID", keytype = "Entrez",
                         x = "Control", y = "Treatment",
                         enrich_method = "ORT", top = 5,
                         limit = c(2, 100),
  ...
  colnames(gg) = c("GeneID", "Control", "Treatment", "group")
  gg = gg[!(is.na(gg$GeneID)|duplicated(gg$GeneID)), ]
  ...
  #====GO_KEGG_enrichment=====
  geneList = gg$Control[idx1]; names(geneList) = gg$GeneID[idx1]
  enrich1 = EnrichAnalyzer(geneList = geneList, universe = gg$GeneID, keytype = keytype,
                           method = enrich_method, limit = limit, pvalueCutoff = 1,
                           type = "KEGG+REACTOME+GOBP+Complex", verbose = verbose)
  ...
  #====GO_KEGG_enrichment=====
  geneList = gg$Treatment[idx2]; names(geneList) = gg$GeneID[idx2]
  enrich2 = EnrichAnalyzer(geneList = geneList, universe = gg$GeneID, keytype = keytype,
                           method = enrich_method, limit = limit, pvalueCutoff = 1,
                           type = "KEGG+REACTOME+GOBP+Complex", verbose = verbose)
  ...
  #====GO_KEGG_enrichment=====
  geneList = gg$Control[idx3]; names(geneList) = gg$GeneID[idx3]
  enrich3 = EnrichAnalyzer(geneList = geneList, universe = gg$GeneID, keytype = keytype,
                           method = enrich_method, limit = limit, pvalueCutoff = 1,
                           type = "KEGG+REACTOME+GOBP+Complex", verbose = verbose)
  ...
  #====GO_KEGG_enrichment=====
  geneList = gg$Treatment[idx4]; names(geneList) = gg$GeneID[idx4]
  enrich4 = EnrichAnalyzer(geneList = geneList, universe = gg$GeneID, keytype = keytype,
                           method = enrich_method, limit = limit, pvalueCutoff = 1,
                           type = "KEGG+REACTOME+GOBP+Complex", verbose = verbose)
  ...
  #====GO_KEGG_enrichment=====
  geneList = abs(gg$Diff[idx1|idx2]); names(geneList) = gg$GeneID[idx1|idx2]
  enrich12 = EnrichAnalyzer(geneList = geneList, universe = gg$GeneID, keytype = keytype,
                            method = enrich_method, limit = limit, pvalueCutoff = 1,
                            type = "KEGG+REACTOME+GOBP+Complex", verbose = verbose)
  ...
  #====GO_KEGG_enrichment=====
  geneList = gg$Control[idx1|idx3]; names(geneList) = gg$GeneID[idx1|idx3]
  enrich13 = EnrichAnalyzer(geneList = geneList, universe = gg$GeneID, keytype = keytype,
                            method = enrich_method, limit = limit, pvalueCutoff = 1,
                            type = "KEGG+REACTOME+GOBP+Complex", verbose = verbose)
  ...
  #====GO_KEGG_enrichment=====
  geneList = gg$Treatment[idx4|idx2]; names(geneList) = gg$GeneID[idx4|idx2]
  enrich24 = EnrichAnalyzer(geneList = geneList, universe = gg$GeneID, keytype = keytype,
                            method = enrich_method, limit = limit, pvalueCutoff = 1,
                            type = "KEGG+REACTOME+GOBP+Complex", verbose = verbose)
  ...
  #====GO_KEGG_enrichment=====
  geneList = gg$Diff[idx3|idx4]; names(geneList) = gg$GeneID[idx3|idx4]
  enrich34 = EnrichAnalyzer(geneList = geneList, universe = gg$GeneID, keytype = keytype,
                            method = enrich_method, limit = limit, pvalueCutoff = 1,
                            type = "KEGG+REACTOME+GOBP+Complex", verbose = verbose)
